#ifndef _ACTORScombiner
#define _ACTORScombiner

// Macro for placing the data on corresponding core's memory 
#undef  SECTION 
#define SECTION(x) __attribute__((section(x))) 

int combiner( ) SECTION(".core4.text");
int combiner_checkFlag(volatile int*) SECTION(".core4.text");
static void combiner_accumulate( ) SECTION(".core4.text");
