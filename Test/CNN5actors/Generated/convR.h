...
int convR( ) SECTION(".core1.text");
int convR_checkFlag(volatile int*) SECTION(".core1.text");
static void convR_initReadInput( ) SECTION(".core1.text");
static void convR_readInput( ) SECTION(".core1.text");
static void convR_readInput_done( ) SECTION(".core1.text");
static void convR___acc__applyFilter( ) SECTION(".core1.text");
static void convR_applyFilter_done( ) SECTION(".core1.text");
void initStateVarsconvR() SECTION(".core1.text");
