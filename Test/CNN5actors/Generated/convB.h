...
int convB( ) SECTION(".core3.text");
int convB_checkFlag(volatile int*) SECTION(".core3.text");
static void convB_initReadInput( ) SECTION(".core3.text");
static void convB_readInput( ) SECTION(".core3.text");
static void convB_readInput_done( ) SECTION(".core3.text");
static void convB___acc__applyFilter( ) SECTION(".core3.text");
static void convB_applyFilter_done( ) SECTION(".core3.text");
void initStateVarsconvB() SECTION(".core3.text");
