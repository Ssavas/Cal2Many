...
int convG( ) SECTION(".core2.text");
int convG_checkFlag(volatile int*) SECTION(".core2.text");
static void convG_initReadInput( ) SECTION(".core2.text");
static void convG_readInput( ) SECTION(".core2.text");
static void convG_readInput_done( ) SECTION(".core2.text");
static void convG___acc__applyFilter( ) SECTION(".core2.text");
static void convG_applyFilter_done( ) SECTION(".core2.text");
void initStateVarsconvG() SECTION(".core2.text");
