#ifndef _ACTORSbeamer_2
#define _ACTORSbeamer_2

// Macro for placing the data on corresponding core's memory 
#undef  SECTION 
#define SECTION(x) __attribute__((section(x))) 

int beamer_2( ) SECTION(".core7.text");
int beamer_2_checkFlag(volatile int*) SECTION(".core7.text");
static void beamer_2_set_ra_rb_pos( ) SECTION(".core7.text");
static void beamer_2_read_ra_val( ) SECTION(".core7.text");
static void beamer_2_read_ra_val_done( ) SECTION(".core7.text");
static void beamer_2_read_rb_val( ) SECTION(".core7.text");
static void beamer_2_read_rb_val_done( ) SECTION(".core7.text");
static void beamer_2_beam_int_loop_1( ) SECTION(".core7.text");
static void beamer_2_beam_int_loop_1_done( ) SECTION(".core7.text");
static void beamer_2_beam_int_loop_2( ) SECTION(".core7.text");
static void beamer_2_beam_int_loop_2_done( ) SECTION(".core7.text");
static void beamer_2_store_ba_results( ) SECTION(".core7.text");
static void beamer_2_store_bb_results( ) SECTION(".core7.text");
static void beamer_2_correlation( ) SECTION(".core7.text");
static void beamer_2_set_cubic_inputs( ) SECTION(".core7.text");
static void beamer_2_set_cubic_inputs_done( ) SECTION(".core7.text");
static void beamer_2___acc__cubic( ) SECTION(".core7.text");
static void beamer_2_set_ba_bb_pos( ) SECTION(".core7.text");
void initStateVarsbeamer_2() SECTION(".core7.text");
