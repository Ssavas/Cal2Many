#ifndef _ACTORSbeamer_4
#define _ACTORSbeamer_4

// Macro for placing the data on corresponding core's memory 
#undef  SECTION 
#define SECTION(x) __attribute__((section(x))) 

int beamer_4( ) SECTION(".core9.text");
int beamer_4_checkFlag(volatile int*) SECTION(".core9.text");
static void beamer_4_set_ra_rb_pos( ) SECTION(".core9.text");
static void beamer_4_read_ra_val( ) SECTION(".core9.text");
static void beamer_4_read_ra_val_done( ) SECTION(".core9.text");
static void beamer_4_read_rb_val( ) SECTION(".core9.text");
static void beamer_4_read_rb_val_done( ) SECTION(".core9.text");
static void beamer_4_beam_int_loop_1( ) SECTION(".core9.text");
static void beamer_4_beam_int_loop_1_done( ) SECTION(".core9.text");
static void beamer_4_beam_int_loop_2( ) SECTION(".core9.text");
static void beamer_4_beam_int_loop_2_done( ) SECTION(".core9.text");
static void beamer_4_store_ba_results( ) SECTION(".core9.text");
static void beamer_4_store_bb_results( ) SECTION(".core9.text");
static void beamer_4_correlation( ) SECTION(".core9.text");
static void beamer_4_set_cubic_inputs( ) SECTION(".core9.text");
static void beamer_4_set_cubic_inputs_done( ) SECTION(".core9.text");
static void beamer_4___acc__cubic( ) SECTION(".core9.text");
static void beamer_4_set_ba_bb_pos( ) SECTION(".core9.text");
void initStateVarsbeamer_4() SECTION(".core9.text");
