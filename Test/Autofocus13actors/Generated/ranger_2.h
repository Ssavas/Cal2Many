#ifndef _ACTORSranger_2
#define _ACTORSranger_2

// Macro for placing the data on corresponding core's memory 
#undef  SECTION 
#define SECTION(x) __attribute__((section(x))) 

int ranger_2( ) SECTION(".core1.text");
int ranger_2_checkFlag(volatile int*) SECTION(".core1.text");
static void ranger_2_set_pa_pb( ) SECTION(".core1.text");
static void ranger_2_range_int_loop_1( ) SECTION(".core1.text");
static void ranger_2_range_int_loop_1_done( ) SECTION(".core1.text");
static void ranger_2_range_int_loop_2( ) SECTION(".core1.text");
static void ranger_2_range_int_loop_2_done( ) SECTION(".core1.text");
static void ranger_2_store_ra_results( ) SECTION(".core1.text");
static void ranger_2_store_rb_results( ) SECTION(".core1.text");
static void ranger_2_set_cubic_inputs( ) SECTION(".core1.text");
static void ranger_2_set_cubic_inputs_done( ) SECTION(".core1.text");
static void ranger_2___acc__cubic( ) SECTION(".core1.text");
void initStateVarsranger_2() SECTION(".core1.text");
