#ifndef _ACTORSbeamer_3
#define _ACTORSbeamer_3

// Macro for placing the data on corresponding core's memory 
#undef  SECTION 
#define SECTION(x) __attribute__((section(x))) 

int beamer_3( ) SECTION(".core8.text");
int beamer_3_checkFlag(volatile int*) SECTION(".core8.text");
static void beamer_3_set_ra_rb_pos( ) SECTION(".core8.text");
static void beamer_3_read_ra_val( ) SECTION(".core8.text");
static void beamer_3_read_ra_val_done( ) SECTION(".core8.text");
static void beamer_3_read_rb_val( ) SECTION(".core8.text");
static void beamer_3_read_rb_val_done( ) SECTION(".core8.text");
static void beamer_3_beam_int_loop_1( ) SECTION(".core8.text");
static void beamer_3_beam_int_loop_1_done( ) SECTION(".core8.text");
static void beamer_3_beam_int_loop_2( ) SECTION(".core8.text");
static void beamer_3_beam_int_loop_2_done( ) SECTION(".core8.text");
static void beamer_3_store_ba_results( ) SECTION(".core8.text");
static void beamer_3_store_bb_results( ) SECTION(".core8.text");
static void beamer_3_correlation( ) SECTION(".core8.text");
static void beamer_3_set_cubic_inputs( ) SECTION(".core8.text");
static void beamer_3_set_cubic_inputs_done( ) SECTION(".core8.text");
static void beamer_3___acc__cubic( ) SECTION(".core8.text");
static void beamer_3_set_ba_bb_pos( ) SECTION(".core8.text");
void initStateVarsbeamer_3() SECTION(".core8.text");
