...
volatile int* ranger_3_ch4_ready SECTION(".core2.data");
volatile int* ranger_3_ch4_valid SECTION(".core2.data");
volatile int* ranger_3_ch5_ready SECTION(".core2.data");
volatile int* ranger_3_ch5_valid SECTION(".core2.data");
...
int ranger_3_checkFlag(volatile int* flag){
	while(*flag == 0);
	return 1;
}
...
static inline void ranger_3_store_ra_results ( ) {
	...
	while(*ranger_3_ch4_ready == 0);// Wait for the ready signal. 
...
static inline void ranger_3_store_rb_results ( ) {
	...
	while(*ranger_3_ch5_ready == 0);// Wait for the ready signal. 
...
int int_state_vars_ranger_3 SECTION(".core2.data") = 1;
