#ifndef _ACTORSranger_5
#define _ACTORSranger_5

// Macro for placing the data on corresponding core's memory 
#undef  SECTION 
#define SECTION(x) __attribute__((section(x))) 

int ranger_5( ) SECTION(".core4.text");
int ranger_5_checkFlag(volatile int*) SECTION(".core4.text");
static void ranger_5_set_pa_pb( ) SECTION(".core4.text");
static void ranger_5_range_int_loop_1( ) SECTION(".core4.text");
static void ranger_5_range_int_loop_1_done( ) SECTION(".core4.text");
static void ranger_5_range_int_loop_2( ) SECTION(".core4.text");
static void ranger_5_range_int_loop_2_done( ) SECTION(".core4.text");
static void ranger_5_store_ra_results( ) SECTION(".core4.text");
static void ranger_5_store_rb_results( ) SECTION(".core4.text");
static void ranger_5_set_cubic_inputs( ) SECTION(".core4.text");
static void ranger_5_set_cubic_inputs_done( ) SECTION(".core4.text");
static void ranger_5___acc__cubic( ) SECTION(".core4.text");
void initStateVarsranger_5() SECTION(".core4.text");
