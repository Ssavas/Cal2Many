...
class cubic() extends Module {
	val io = IO(new Bundle{
		val ranger_2_complex_input1_p_pos_in = Input(UInt(width = 64.W))
		val ranger_2_complex_input1_p_val_in = Input(UInt(width = 64.W))
		val ranger_2_complex_input2_p_pos_in = Input(UInt(width = 64.W))
		val ranger_2_complex_input2_p_val_in = Input(UInt(width = 64.W))
		val ranger_2_complex_output_p_out = Output(UInt(width = 32.W))
		val en = Input(Bool())
	...
	def NOF_PIXELS : Int = 2166

	//Read the inputs
	val ranger_2_complex_input1_p_pos_v0 = io.ranger_2_complex_input1_p_pos_in
	val ranger_2_complex_input1_p_val_v0 = io.ranger_2_complex_input1_p_val_in
	val ranger_2_complex_input2_p_pos_v0 = io.ranger_2_complex_input2_p_pos_in
	val ranger_2_complex_input2_p_val_v0 = io.ranger_2_complex_input2_p_val_in
...
FP_div0.io.out
	...
	//Write the outputs
	// ranger_2_complex_output_p_v0 total delay : 0
	io.ranger_2_complex_output_p_out := ranger_2_complex_output_p_v0
	io.valid := io.en
}
