#ifndef _ACTORSranger_4
#define _ACTORSranger_4

// Macro for placing the data on corresponding core's memory 
#undef  SECTION 
#define SECTION(x) __attribute__((section(x))) 

int ranger_4( ) SECTION(".core3.text");
int ranger_4_checkFlag(volatile int*) SECTION(".core3.text");
static void ranger_4_set_pa_pb( ) SECTION(".core3.text");
static void ranger_4_range_int_loop_1( ) SECTION(".core3.text");
static void ranger_4_range_int_loop_1_done( ) SECTION(".core3.text");
static void ranger_4_range_int_loop_2( ) SECTION(".core3.text");
static void ranger_4_range_int_loop_2_done( ) SECTION(".core3.text");
static void ranger_4_store_ra_results( ) SECTION(".core3.text");
static void ranger_4_store_rb_results( ) SECTION(".core3.text");
static void ranger_4_set_cubic_inputs( ) SECTION(".core3.text");
static void ranger_4_set_cubic_inputs_done( ) SECTION(".core3.text");
static void ranger_4___acc__cubic( ) SECTION(".core3.text");
void initStateVarsranger_4() SECTION(".core3.text");
