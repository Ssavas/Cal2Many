#ifndef _ACTORSbeamer_1
#define _ACTORSbeamer_1

// Macro for placing the data on corresponding core's memory 
#undef  SECTION 
#define SECTION(x) __attribute__((section(x))) 

int beamer_1( ) SECTION(".core6.text");
int beamer_1_checkFlag(volatile int*) SECTION(".core6.text");
static void beamer_1_set_ra_rb_pos( ) SECTION(".core6.text");
static void beamer_1_read_ra_val( ) SECTION(".core6.text");
static void beamer_1_read_ra_val_done( ) SECTION(".core6.text");
static void beamer_1_read_rb_val( ) SECTION(".core6.text");
static void beamer_1_read_rb_val_done( ) SECTION(".core6.text");
static void beamer_1_beam_int_loop_1( ) SECTION(".core6.text");
static void beamer_1_beam_int_loop_1_done( ) SECTION(".core6.text");
static void beamer_1_beam_int_loop_2( ) SECTION(".core6.text");
static void beamer_1_beam_int_loop_2_done( ) SECTION(".core6.text");
static void beamer_1_store_ba_results( ) SECTION(".core6.text");
static void beamer_1_store_bb_results( ) SECTION(".core6.text");
static void beamer_1_correlation( ) SECTION(".core6.text");
static void beamer_1_set_cubic_inputs( ) SECTION(".core6.text");
static void beamer_1_set_cubic_inputs_done( ) SECTION(".core6.text");
static void beamer_1___acc__cubic( ) SECTION(".core6.text");
static void beamer_1_set_ba_bb_pos( ) SECTION(".core6.text");
void initStateVarsbeamer_1() SECTION(".core6.text");
