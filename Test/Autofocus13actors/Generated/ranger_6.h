#ifndef _ACTORSranger_6
#define _ACTORSranger_6

// Macro for placing the data on corresponding core's memory 
#undef  SECTION 
#define SECTION(x) __attribute__((section(x))) 

int ranger_6( ) SECTION(".core5.text");
int ranger_6_checkFlag(volatile int*) SECTION(".core5.text");
static void ranger_6_set_pa_pb( ) SECTION(".core5.text");
static void ranger_6_range_int_loop_1( ) SECTION(".core5.text");
static void ranger_6_range_int_loop_1_done( ) SECTION(".core5.text");
static void ranger_6_range_int_loop_2( ) SECTION(".core5.text");
static void ranger_6_range_int_loop_2_done( ) SECTION(".core5.text");
static void ranger_6_store_ra_results( ) SECTION(".core5.text");
static void ranger_6_store_rb_results( ) SECTION(".core5.text");
static void ranger_6_set_cubic_inputs( ) SECTION(".core5.text");
static void ranger_6_set_cubic_inputs_done( ) SECTION(".core5.text");
static void ranger_6___acc__cubic( ) SECTION(".core5.text");
void initStateVarsranger_6() SECTION(".core5.text");
