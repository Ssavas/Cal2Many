...
int* beamer_6_ch10_ready SECTION(".core11.data");
int* beamer_6_ch10_valid SECTION(".core11.data");
int* beamer_6_ch11_ready SECTION(".core11.data");
int* beamer_6_ch11_valid SECTION(".core11.data");

//OutputPorts
uint64_t* beamer_6_ch22_buffer SECTION(".core11.data");
uint64_t* beamer_6_ch23_buffer SECTION(".core11.data");
int* beamer_6_ch22_ready SECTION(".core11.data");
int* beamer_6_ch22_valid SECTION(".core11.data");
int* beamer_6_ch23_ready SECTION(".core11.data");
int* beamer_6_ch23_valid SECTION(".core11.data");
...
static inline void beamer_6_read_ra_val ( ) {
	int32_t i;
	int64_t ra_val [18];
	for(int beamer_6_read_ra_val_i = 0; beamer_6_read_ra_val_i < 18; beamer_6_read_ra_val_i++){
		ra_val[beamer_6_read_ra_val_i] = beamer_6_ch10_buffer[beamer_6_read_ra_val_i]; //read input 
	}
	...
	*beamer_6_ch10_valid = 0; // no valid input left on the channel
	...
	while (( i < 18 )) {
		beamer_6_complex_ra[i][1] = ra_val[i];
		i = (i + 1);
...
static inline void beamer_6_read_rb_val ( ) {
	int32_t i;
	int64_t rb_val [18];
	for(int beamer_6_read_rb_val_i = 0; beamer_6_read_rb_val_i < 18; beamer_6_read_rb_val_i++){
		rb_val[beamer_6_read_rb_val_i] = beamer_6_ch11_buffer[beamer_6_read_rb_val_i]; //read input 
	}
	...
	*beamer_6_ch11_valid = 0; // no valid input left on the channel
	...
	while (( i < 18 )) {
		beamer_6_complex_rb[i][1] = rb_val[i];
		i = (i + 1);
...
beamer_6_Action_0:
			...
			if ((*beamer_6_ch22_ready == 1 && *beamer_6_ch23_ready == 1)){ 
