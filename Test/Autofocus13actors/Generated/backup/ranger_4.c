...
int* ranger_4_ch6_ready SECTION(".core3.data");
int* ranger_4_ch6_valid SECTION(".core3.data");
int* ranger_4_ch7_ready SECTION(".core3.data");
int* ranger_4_ch7_valid SECTION(".core3.data");
