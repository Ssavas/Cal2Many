...
int* beamer_5_ch8_ready SECTION(".core10.data");
int* beamer_5_ch8_valid SECTION(".core10.data");
int* beamer_5_ch9_ready SECTION(".core10.data");
int* beamer_5_ch9_valid SECTION(".core10.data");

//OutputPorts
uint64_t* beamer_5_ch20_buffer SECTION(".core10.data");
uint64_t* beamer_5_ch21_buffer SECTION(".core10.data");
int* beamer_5_ch20_ready SECTION(".core10.data");
int* beamer_5_ch20_valid SECTION(".core10.data");
int* beamer_5_ch21_ready SECTION(".core10.data");
int* beamer_5_ch21_valid SECTION(".core10.data");
...
static inline void beamer_5_read_ra_val ( ) {
	int32_t i;
	int64_t ra_val [18];
	for(int beamer_5_read_ra_val_i = 0; beamer_5_read_ra_val_i < 18; beamer_5_read_ra_val_i++){
		ra_val[beamer_5_read_ra_val_i] = beamer_5_ch8_buffer[beamer_5_read_ra_val_i]; //read input 
	}
	...
	*beamer_5_ch8_valid = 0; // no valid input left on the channel
	...
	while (( i < 18 )) {
		beamer_5_complex_ra[i][1] = ra_val[i];
		i = (i + 1);
...
static inline void beamer_5_read_rb_val ( ) {
	int32_t i;
	int64_t rb_val [18];
	for(int beamer_5_read_rb_val_i = 0; beamer_5_read_rb_val_i < 18; beamer_5_read_rb_val_i++){
		rb_val[beamer_5_read_rb_val_i] = beamer_5_ch9_buffer[beamer_5_read_rb_val_i]; //read input 
	}
	...
	*beamer_5_ch9_valid = 0; // no valid input left on the channel
	...
	while (( i < 18 )) {
		beamer_5_complex_rb[i][1] = rb_val[i];
		i = (i + 1);
...
beamer_5_Action_0:
			...
			if ((*beamer_5_ch20_ready == 1 && *beamer_5_ch21_ready == 1)){ 
