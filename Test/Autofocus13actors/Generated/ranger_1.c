...
volatile int* ranger_1_ch0_ready;
volatile int* ranger_1_ch0_valid;
volatile int* ranger_1_ch1_ready;
volatile int* ranger_1_ch1_valid;

#define NOF_PIXELS_KERNEL (36) 
#define NOF_PIXELS ((216 / 6)) 
int64_t ranger_1_complex_p0_pos;
int64_t ranger_1_complex_p0_val;
int64_t ranger_1_complex_p1_pos;
int64_t ranger_1_complex_p1_val;
int64_t ranger_1_complex_p2_pos;
int64_t ranger_1_complex_p2_val;
int64_t ranger_1_complex_p3_pos;
int64_t ranger_1_complex_p3_val;
int64_t ranger_1_complex_p01;
int64_t ranger_1_complex_p12;
int64_t ranger_1_complex_p23;
int64_t ranger_1_complex_p02;
int64_t ranger_1_complex_p13;
int64_t ranger_1_complex_input1_p_pos;
int64_t ranger_1_complex_input1_p_val;
int64_t ranger_1_complex_input2_p_pos;
int64_t ranger_1_complex_input2_p_val;
int64_t ranger_1_complex_output_p;
int32_t ranger_1_input_state;
int32_t ranger_1_range1_i = 0;
int32_t ranger_1_range1_counter = 0;
int32_t ranger_1_range2_i = 0;
int32_t ranger_1_range2_counter = 0;
int32_t ranger_1_inputData_index = 0;
int64_t ranger_1_complex_pa[NOF_PIXELS_KERNEL][2];

int64_t ranger_1_complex_pb[NOF_PIXELS_KERNEL][2];

int32_t ranger_1_ranger_1_State;
...
int32_t ranger_1_ranger_1_IntCheckOutput = -1;
int ranger_1_checkFlag(volatile int* flag){
	while(*flag == 0);
	return 1;
}
...
static inline void ranger_1_store_ra_results ( ) {
	...
	while(*ranger_1_ch0_ready == 0);// Wait for the ready signal. 
...
static inline void ranger_1_store_rb_results ( ) {
	...
	while(*ranger_1_ch1_ready == 0);// Wait for the ready signal. 
