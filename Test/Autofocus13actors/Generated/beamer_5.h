#ifndef _ACTORSbeamer_5
#define _ACTORSbeamer_5

// Macro for placing the data on corresponding core's memory 
#undef  SECTION 
#define SECTION(x) __attribute__((section(x))) 

int beamer_5( ) SECTION(".core10.text");
int beamer_5_checkFlag(volatile int*) SECTION(".core10.text");
static void beamer_5_set_ra_rb_pos( ) SECTION(".core10.text");
static void beamer_5_read_ra_val( ) SECTION(".core10.text");
static void beamer_5_read_ra_val_done( ) SECTION(".core10.text");
static void beamer_5_read_rb_val( ) SECTION(".core10.text");
static void beamer_5_read_rb_val_done( ) SECTION(".core10.text");
static void beamer_5_beam_int_loop_1( ) SECTION(".core10.text");
static void beamer_5_beam_int_loop_1_done( ) SECTION(".core10.text");
static void beamer_5_beam_int_loop_2( ) SECTION(".core10.text");
static void beamer_5_beam_int_loop_2_done( ) SECTION(".core10.text");
static void beamer_5_store_ba_results( ) SECTION(".core10.text");
static void beamer_5_store_bb_results( ) SECTION(".core10.text");
static void beamer_5_correlation( ) SECTION(".core10.text");
static void beamer_5_set_cubic_inputs( ) SECTION(".core10.text");
static void beamer_5_set_cubic_inputs_done( ) SECTION(".core10.text");
static void beamer_5___acc__cubic( ) SECTION(".core10.text");
static void beamer_5_set_ba_bb_pos( ) SECTION(".core10.text");
void initStateVarsbeamer_5() SECTION(".core10.text");
