#ifndef _ACTORSbeamer_6
#define _ACTORSbeamer_6

// Macro for placing the data on corresponding core's memory 
#undef  SECTION 
#define SECTION(x) __attribute__((section(x))) 

int beamer_6( ) SECTION(".core11.text");
int beamer_6_checkFlag(volatile int*) SECTION(".core11.text");
static void beamer_6_set_ra_rb_pos( ) SECTION(".core11.text");
static void beamer_6_read_ra_val( ) SECTION(".core11.text");
static void beamer_6_read_ra_val_done( ) SECTION(".core11.text");
static void beamer_6_read_rb_val( ) SECTION(".core11.text");
static void beamer_6_read_rb_val_done( ) SECTION(".core11.text");
static void beamer_6_beam_int_loop_1( ) SECTION(".core11.text");
static void beamer_6_beam_int_loop_1_done( ) SECTION(".core11.text");
static void beamer_6_beam_int_loop_2( ) SECTION(".core11.text");
static void beamer_6_beam_int_loop_2_done( ) SECTION(".core11.text");
static void beamer_6_store_ba_results( ) SECTION(".core11.text");
static void beamer_6_store_bb_results( ) SECTION(".core11.text");
static void beamer_6_correlation( ) SECTION(".core11.text");
static void beamer_6_set_cubic_inputs( ) SECTION(".core11.text");
static void beamer_6_set_cubic_inputs_done( ) SECTION(".core11.text");
static void beamer_6___acc__cubic( ) SECTION(".core11.text");
static void beamer_6_set_ba_bb_pos( ) SECTION(".core11.text");
void initStateVarsbeamer_6() SECTION(".core11.text");
