#ifndef _ACTORSranger_3
#define _ACTORSranger_3

// Macro for placing the data on corresponding core's memory 
#undef  SECTION 
#define SECTION(x) __attribute__((section(x))) 

int ranger_3( ) SECTION(".core2.text");
int ranger_3_checkFlag(volatile int*) SECTION(".core2.text");
static void ranger_3_set_pa_pb( ) SECTION(".core2.text");
static void ranger_3_range_int_loop_1( ) SECTION(".core2.text");
static void ranger_3_range_int_loop_1_done( ) SECTION(".core2.text");
static void ranger_3_range_int_loop_2( ) SECTION(".core2.text");
static void ranger_3_range_int_loop_2_done( ) SECTION(".core2.text");
static void ranger_3_store_ra_results( ) SECTION(".core2.text");
static void ranger_3_store_rb_results( ) SECTION(".core2.text");
static void ranger_3_set_cubic_inputs( ) SECTION(".core2.text");
static void ranger_3_set_cubic_inputs_done( ) SECTION(".core2.text");
static void ranger_3___acc__cubic( ) SECTION(".core2.text");
void initStateVarsranger_3() SECTION(".core2.text");
