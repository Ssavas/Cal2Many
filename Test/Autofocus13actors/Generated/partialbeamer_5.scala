...
class cubic() extends Module {
	val io = IO(new Bundle{
		val beamer_5_complex_input1_p_pos_in = Input(UInt(width = 64.W))
		val beamer_5_complex_input1_p_val_in = Input(UInt(width = 64.W))
		val beamer_5_complex_input2_p_pos_in = Input(UInt(width = 64.W))
		val beamer_5_complex_input2_p_val_in = Input(UInt(width = 64.W))
		val beamer_5_complex_output_p_out = Output(UInt(width = 32.W))
		val en = Input(Bool())
	...
	//Read the inputs
	val beamer_5_complex_input1_p_pos_v0 = io.beamer_5_complex_input1_p_pos_in
	val beamer_5_complex_input1_p_val_v0 = io.beamer_5_complex_input1_p_val_in
	val beamer_5_complex_input2_p_pos_v0 = io.beamer_5_complex_input2_p_pos_in
	val beamer_5_complex_input2_p_val_v0 = io.beamer_5_complex_input2_p_val_in
...
FP_div0.io.out
	...
	//Write the outputs
	// beamer_5_complex_output_p_v0 total delay : 0
	io.beamer_5_complex_output_p_out := beamer_5_complex_output_p_v0
	io.valid := io.en
}
