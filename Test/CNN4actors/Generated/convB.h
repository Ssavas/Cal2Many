...
int convB( ) SECTION(".core2.text");
int convB_checkFlag(volatile int*) SECTION(".core2.text");
static void convB___acc__applyFilter( ) SECTION(".core2.text");
static void convB_applyFilter_done( ) SECTION(".core2.text");
