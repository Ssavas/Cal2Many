...
int convG( ) SECTION(".core1.text");
int convG_checkFlag(volatile int*) SECTION(".core1.text");
static void convG___acc__applyFilter( ) SECTION(".core1.text");
static void convG_applyFilter_done( ) SECTION(".core1.text");
