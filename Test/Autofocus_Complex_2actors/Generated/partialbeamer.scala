...
class correlation() extends Module {
	val io = IO(new Bundle{
		val correlation_input1_in = Input(UInt(width = 64.W))
		val correlation_input2_in = Input(UInt(width = 64.W))
		val total_sum_in = Input(UInt(width = 32.W))
		val total_sum_out = Output(UInt(width = 32.W))
		val en = Input(Bool())
	...
	val total_sum_v1 = Wire(UInt(width = 32.W))
	val tmp2_v1 = Wire(UInt(width = 32.W))

	//Read the inputs
	val correlation_input1_v0 = io.correlation_input1_in
	val correlation_input2_v0 = io.correlation_input2_in
	val total_sum_v0 = io.total_sum_in

	
	val c_mag0 = Module(new C_mag())
	c_mag0.io.in := correlation_input1_v0
	val C_mag_ret_v0 = c_mag0.io.out
	tmp1_v1 := C_mag_ret_v0	// tmp1_v1 total delay: 9
	
	val c_mag1 = Module(new C_mag())
	c_mag1.io.in := correlation_input2_v0
	...
	total_sum_v1 := FP_add0.io.out
	val total_sum_v0_Reg0 = RegNext(total_sum_v0, 0.U)
	val total_sum_v0_Reg1 = RegNext(total_sum_v0_Reg0, 0.U)
	val total_sum_v0_Reg2 = RegNext(total_sum_v0_Reg1, 0.U)
	val total_sum_v0_Reg3 = RegNext(total_sum_v0_Reg2, 0.U)
	val total_sum_v0_Reg4 = RegNext(total_sum_v0_Reg3, 0.U)
	val total_sum_v0_Reg5 = RegNext(total_sum_v0_Reg4, 0.U)
	val total_sum_v0_Reg6 = RegNext(total_sum_v0_Reg5, 0.U)
	val total_sum_v0_Reg7 = RegNext(total_sum_v0_Reg6, 0.U)
	val total_sum_v0_Reg8 = RegNext(total_sum_v0_Reg7, 0.U)
	val total_sum_v0_Reg9 = RegNext(total_sum_v0_Reg8, 0.U)
	val total_sum_v0_Reg10 = RegNext(total_sum_v0_Reg9, 0.U)
	val total_sum_v0_Reg11 = RegNext(total_sum_v0_Reg10, 0.U)
	val total_sum_v0_Reg12 = RegNext(total_sum_v0_Reg11, 0.U)
	FP_add0.io.in1 := total_sum_v0_Reg12
	FP_add0.io.in2 := tmp5_v1
	// total_sum_v1 total delay: 16

	//Write the outputs
	// total_sum_v1 total delay : 16
	io.total_sum_out := total_sum_v1
