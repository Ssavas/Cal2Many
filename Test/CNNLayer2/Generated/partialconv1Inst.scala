...
class applyFilter() extends Module {
	val io = IO(new Bundle{
		...
		val conv1Inst_inputImage_in = Input(UInt(width = 32.W))
	...
	def outputRowSize : Int = 115
	def outputColSize : Int = 115
	def stride : Int = 2
	...
	val conv1Inst_inputImage_v0 = io.conv1Inst_inputImage_in

	
	val conv70 = Module(new convolution7())
	conv70.io.filterIndex := conv1Inst_filterCounter_v0
	conv70.io.patchData := conv1Inst_inputImage_v0
