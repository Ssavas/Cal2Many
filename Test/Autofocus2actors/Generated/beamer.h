#ifndef _ACTORSbeamer
#define _ACTORSbeamer

// Macro for placing the data on corresponding core's memory 
#undef  SECTION 
#define SECTION(x) __attribute__((section(x))) 

int beamer( ) SECTION(".core1.text");
int beamer_checkFlag(volatile int*) SECTION(".core1.text");
static void beamer_set_ra_rb_pos( ) SECTION(".core1.text");
static void beamer_read_ra_val( ) SECTION(".core1.text");
static void beamer_read_ra_val_done( ) SECTION(".core1.text");
static void beamer_read_rb_val( ) SECTION(".core1.text");
static void beamer_read_rb_val_done( ) SECTION(".core1.text");
static void beamer_beam_int_loop_1( ) SECTION(".core1.text");
static void beamer_beam_int_loop_1_done( ) SECTION(".core1.text");
static void beamer_beam_int_loop_2( ) SECTION(".core1.text");
static void beamer_beam_int_loop_2_done( ) SECTION(".core1.text");
static void beamer_store_ba_results( ) SECTION(".core1.text");
static void beamer_store_bb_results( ) SECTION(".core1.text");
static void beamer_set_correlation_inputs( ) SECTION(".core1.text");
static void beamer___acc__correlation( ) SECTION(".core1.text");
static void beamer_correlation_done( ) SECTION(".core1.text");
static void beamer_set_cubic_inputs( ) SECTION(".core1.text");
static void beamer_set_cubic_inputs_done( ) SECTION(".core1.text");
static void beamer___acc__cubic( ) SECTION(".core1.text");
static void beamer_set_ba_bb_pos( ) SECTION(".core1.text");
static void C_mag( ) SECTION(".core1.text");
void initStateVarsbeamer() SECTION(".core1.text");
